...
<tt>git clone git://github.com/tinycodefactory/Automatify.git .capistrano</tt>

and copy the caprc file from the .capistano folder to your user folder

<tt>mv .capistrano/caprc .caprc</tt>

=== Test

<tt>cap -T</tt> and you should see some extra global tasks
